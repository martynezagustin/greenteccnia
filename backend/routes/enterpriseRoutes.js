...
router.post("/:userId/add-enterprise", authMiddleware, enterpriseController.addEnterprise)
router.post("/:userId/enterprise/add-sustainability-options", authMiddleware, enterpriseController.addSustainabilityOptionsToEnterprise)
router.post("/:userId/enterprise/add-certifications-accomplished", authMiddleware, enterpriseController.addCertificationsAccomplished)
router.post("/:userId/enterprise/add-initials-sustainable-objectives", authMiddleware, enterpriseController.addInitialsSustainableObjective)
